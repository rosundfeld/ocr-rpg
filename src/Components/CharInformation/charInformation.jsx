...
export default function CharInformation(char) {
    ...
    //Teste Resistencia
    const [charStrResist, setCharStrResist] = useState("");
    const [charDexResist, setCharDexResist] = useState("");
    const [charConResist, setCharConResist] = useState("");
    const [charIntResist, setCharIntResist] = useState("");
    const [charWisResist, setCharWisResist] = useState("");
    const [charCarResist, setCharCarResist] = useState("");

    //Proficiencias (help)
    const [charProfAcrobacia, setCharAcrobacia] = useState("");
    const [charProfArcanismo, setCharArcanismo] = useState("");
    const [charProfAtletismo, setCharAtletismo] = useState("");
    const [charProfAtuacao, setCharAtuacao] = useState("");
    const [charProfBlefar, setCharBlefar] = useState("");
    const [charProfFurtividade, setCharFurtividade] = useState("");
    const [charProfHistoria, setCharHistoria] = useState("");
    const [charProfIntimidacao, setCharIntimidacao] = useState("");
    const [charProfIntuicao, setCharIntuicao] = useState("");
    const [charProfInvesticacao, setCharInvesticacao] = useState("");
    const [charProfAfinidadeAnimal, setCharAfinidadeAnimal] = useState("");
    const [charProfMedicina, setCharMedicina] = useState("");
    const [charProfNatureza, setCharNatureza] = useState("");
    const [charProfPercepcao, setCharPercepcao] = useState("");
    const [charProfPersuasao, setCharPersuasao] = useState("");
    const [charProfPrestidigitacao, setCharPrestidigitacao] = useState("");
    const [charProfReligiao, setCharReligiao] = useState("");
    const [charProfSobrevivencia, setCharSobrevivencia] = useState("");
    ...
    const [charPVTotais, setCharPVTotais] = useState("");
    ...
    //Dinheiro
    const [charPC, setCharPC] = useState("");
    const [charPP, setCharPP] = useState("");
    const [charPO, setCharPO] = useState("");
    const [charPL, setCharPL] = useState("");
